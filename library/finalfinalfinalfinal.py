...
def user_main():
    ...
    def mail(id, email, name, book, date):
        ...
        def emailSender(id, email, book, date):
            ...
            smtp_port = 465
            sender = "library@bookworms.software"
            password = "As112233@@"
            recipients = [email]
    ...
    def insert_data(list):
        ...
        c.execute(f"INSERT INTO user_info(email, ID, name, rent_time, book) values('{list[0]}', '{list[1]}', '{list[2]}', '{list[3]}', '{list[4]}') ")
    ...
    #this function has been made by Roaa
    def thankyou(name):
            username = name
            if username:
